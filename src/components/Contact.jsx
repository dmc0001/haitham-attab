const Contact = () => {
  return (
    <div id="contact" className="flex flex-col justify-center items-center mb-52">
      ...
      <button
  className="text-[#64FFDA] border-[0.5px] font-fira text-[14px] w-fit py-3 px-12 rounded-[5px] border-[#64FFDA] transition-all duration-300 hover:bg-[#2b9179] hover:text-white hover:border-white"
>
  Hey!
</button>
